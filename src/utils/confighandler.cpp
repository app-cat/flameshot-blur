...
//         KEY                            TYPE                 DEFAULT_VALUE
  ...
  // Interface tab
    ...
    OPTION("contrastUiColor"             ,Color              ({252, 118, 97} )),
    OPTION("contrastOpacity"             ,BoundedInt         ( 0, 255, 128   )),
    ...
    OPTION("drawColor"                   ,Color              ({252, 118, 97} )),
...
//           NAME                           DEFAULT_SHORTCUT
    SHORTCUT("TYPE_PENCIL"              ,                        ),
    SHORTCUT("TYPE_DRAWER"              ,                        ),
    SHORTCUT("TYPE_ARROW"               ,                        ),
    SHORTCUT("TYPE_SELECTION"           ,                        ),
    SHORTCUT("TYPE_RECTANGLE"           ,                        ),
    SHORTCUT("TYPE_CIRCLE"              ,                        ),
    SHORTCUT("TYPE_MOVESELECTION"       ,                        ),
    SHORTCUT("TYPE_UNDO"                ,                        ),
    SHORTCUT("TYPE_COPY"                ,                        ),
    SHORTCUT("TYPE_SAVE"                ,                        ),
    ...
    SHORTCUT("TYPE_INVERT"              ,                        ),
    SHORTCUT("TYPE_TEXT"                ,                        ),
    SHORTCUT("TYPE_TOGGLE_PANEL"        ,                        ),
    SHORTCUT("TYPE_RESIZE_LEFT"         ,                        ),
    SHORTCUT("TYPE_RESIZE_RIGHT"        ,                        ),
    SHORTCUT("TYPE_RESIZE_UP"           ,                        ),
    SHORTCUT("TYPE_RESIZE_DOWN"         ,                        ),
    SHORTCUT("TYPE_SELECT_ALL"          ,                        ),
    SHORTCUT("TYPE_MOVE_LEFT"           ,                        ),
    SHORTCUT("TYPE_MOVE_RIGHT"          ,                        ),
    SHORTCUT("TYPE_MOVE_UP"             ,                        ),
    SHORTCUT("TYPE_MOVE_DOWN"           ,                        ),
